...
import "../../assets/css/member/Policy.css";
...
const Policy = () => {
  ...
  const handleAllAgreeChange = () => {
    const newAgreeState = !allAgree;
    setAllAgree(newAgreeState);
    setAgreements({
      terms: newAgreeState,
      privacy: newAgreeState,
      thirdParty: newAgreeState,
    });
  };
    ...
    <div className="container">
      ...
      <div className="description-container">
        <div className="description box">
          ...
          <p style={{ color: "#ff7c24" }}>약관동의</p>
        </div>
        <FontAwesomeIcon icon={faChevronRight} className="fontawesome-icon" />
        <div className="description box">
          <img src="/assets/images/icon/user-pen.png" alt="user-pen" className="icon" />
          <p>회원정보 입력</p>
        </div>
        <FontAwesomeIcon icon={faChevronRight} className="fontawesome-icon" />
      ...
      <div className="terms-container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="terms-box box2">
            <h3>이용약관 <span style={{ color: "red" }}>(필수)</span></h3>
            <div className="terms-content">
              <textarea readOnly className="terms-content" style={{ whiteSpace: 'pre-wrap' }}
              value={`제1조(목적)

이 약관은 ㈜위드미(전자상거래 사업자)가 운영하는 업체 위드미(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 위드미와 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.`
            ...
            <label>
              <input type="checkbox" name="terms" checked={agreements.terms} onChange={handleCheckboxChange} /> 이용약관에 동의합니다.
            </label>
          </div>

          <div className="terms-box box2">
            <h3>개인정보 처리방침 <span style={{ color: "red" }}>(필수)</span></h3>
            <div className="terms-content">
              <textarea readOnly className="terms-content" style={{ whiteSpace: 'pre-wrap' }}
              value={`1. 총칙

본 업체 위드미는 회원의 개인정보보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여 항상 최선을 다해 노력하고 있습니다.
...
11. 만 18세 미만 회원 가입 제한 및 개인정보 보호

본 사이트는 만 18세 미만의 회원 가입을 허용하지 않으며, 만 18세 미만의 개인정보를 수집하지 않습니다.
만 18세 미만 사용자가 개인정보를 제공한 사실이 확인될 경우, 본 사이트는 해당 정보를 지체 없이 삭제합니다.
...
개인정보 최고 관리책임자 성명 : 홍길동
전화번호 : 031-123-4567
이메일 : widthme@naver.com
...
1) 공고일자 : 2025년 02월 10일
2) 시행일자 : 2025년 02월 10일
              `
            }
             />
            </div>
            <label>
              <input type="checkbox" name="privacy" checked={agreements.privacy} onChange={handleCheckboxChange} /> 개인정보 처리방침에 동의합니다.
            </label>
          </div>
          ...
          <div className="terms-box">
            ...
            <div className="terms-content">
              <textarea readOnly className="terms-content" style={{ whiteSpace: 'pre-wrap' }}
              value={`1. 개인정보의 제3자 제공에 대한 동의

위드미(이하 "회사")는 이용자의 개인정보를 관련 법령에 따라 적법하게 처리하며, 원칙적으로 이용자의 동의 없이 제3자에게 제공하지 않습니다. 다만, 아래의 경우에 한하여 이용자의 동의를 받아 개인정보를 제3자에게 제공할 수 있습니다.


2. 제공받는 자 및 목적

① 협력 병원 및 수의사는 전자 문진 서비스를 제공하고, 상담 및 진료 예약을 위해 이용자의 이름, 연락처, 반려동물 정보, 문진 내용을 제공합니다. 이 정보는 서비스 제공 후 1년 동안 보유되며, 이용자가 동의를 철회할 경우 즉시 삭제됩니다.

② 결제 서비스 업체는 상품 구매 및 결제 처리를 위해 이름, 결제 정보, 연락처를 제공합니다. 관련 법령에 따른 보관 기간 동안 해당 정보가 보유됩니다.

③ 배송 업체는 상품 배송 및 고객 상담을 위해 이름, 연락처, 주소를 제공합니다. 이 정보는 배송 완료 후 3개월 동안 보유됩니다.


3. 이용자의 권리
이용자는 개인정보 제공에 동의하지 않을 수 있으며, 동의하지 않을 경우 일부 서비스 이용이 제한될 수 있습니다. 또한, 동의한 이후에도 언제든지 철회할 수 있습니다.


4. 동의 철회 및 문의
개인정보 제공 동의를 철회하거나 관련 문의 사항이 있을 경우, [고객센터](support@withme.com)로 연락 주시기 바랍니다.`
               }
              />
            </div>
            <label>
              <input type="checkbox" name="thirdParty" checked={agreements.thirdParty} onChange={handleCheckboxChange} /> 개인정보 제3자 제공에 동의합니다.
            </label>
          </div>

          <div className="all-agree">
            <label>
              <input type="checkbox" id="allAgree" checked={allAgree} onChange={handleAllAgreeChange} /> 전체 동의
            </label>
          </div>

          <button type="submit" className="submit-btn">동의하고 가입하기</button>
        </form>
      </div>
    </div>
  );
